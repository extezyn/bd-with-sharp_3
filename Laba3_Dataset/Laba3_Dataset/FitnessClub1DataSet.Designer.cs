...
namespace Laba3_Dataset.FitnessClub1DataSetTableAdapters {
...
SELECT ClassID, ClassDate, MemberID, TrainerID FROM Classes WHERE (ClassID = @ClassID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Laba3_Dataset.Properties.Settings.Default.FitnessClub1ConnectionString;
        }
...
SELECT MemberID, FirstName, LastName, Email FROM Members WHERE (MemberID = @MemberID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT Members.FirstName, Members.LastName,Members.Email, Trainers.FirstName, Tra" +
                "iners.LastName, ClassDate \r\nFROM Classes\r\nINNER JOIN Members ON Classes.MemberID" +
                " = Members.MemberID\r\nINNER JOIN Trainers ON Classes.TrainerID = Trainers.Trainer" +
                "ID;\r\n\r\n";
        ...
        public virtual int FillBy(FitnessClub1DataSet.MembersDataTable dataTable) {
        ...
        public virtual FitnessClub1DataSet.MembersDataTable GetDataBy() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            FitnessClub1DataSet.MembersDataTable dataTable = new FitnessClub1DataSet.MembersDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
